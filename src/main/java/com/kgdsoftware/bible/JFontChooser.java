...
public class JFontChooser extends JComponent
{
	...
	protected class DialogOKAction extends AbstractAction
	{
		...
		protected DialogOKAction(JDialog dialog)
		{
			...
			putValue(Action.NAME, getValue(ACTION_NAME));
		}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, getValue("SelectFont"), true);
	...
	private JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			JLabel label = new JLabel(getValue("FontName"));
	...
	private JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			JLabel label = new JLabel(getValue("FontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	private JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			JLabel label = new JLabel(getValue("FontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), getValue("Sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(getValue("SampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = getValue("Plain");
			fontStyleNames[i++] = getValue("Bold");
			fontStyleNames[i++] = getValue("Italic");
			fontStyleNames[i++] = getValue("BoldItalic");
		}
